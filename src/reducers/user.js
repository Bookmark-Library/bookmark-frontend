...
import {
  ...
  UPDATE_USER, UPDATE_FORM_ERRORS, REMOVE_INPUT, FORM_SUBMITTED,
} from '../actions/user';
...
const reducer = (state = initialState, action = {}) => {
  switch (action.type) {
    ...
    case FORM_SUBMITTED:
      return {
        ...state,
        alias: action.data.pseudo,
        avatarUpload: action.data.avatar,
        emailInscription: action.data.email,
        passwordInscription: action.data.password,
      };
    default:
      return state;
  }
