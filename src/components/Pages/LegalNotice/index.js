    ...
    <div className="row justify-content-center mt-5">
      <div className="col-md-8 col-12">
        ...
        <p className="mt-5">
          ...
          utilisateurs et visiteurs, ci-après l'"Utilisateur", du site "www.bookmark-application.com",
        ...
        <p className=" mt-3">
          ...
          situé au Chemin des Pardiaux 63000 Clermont-Ferrand, avec le numéro de téléphone : 04 44 44 60 40 et l'adresse mail
        ...
        <p className=" mt-3">
        <p>L'Editeur collecte uniquement les données personnelles, telles que votre alias, 
        adresse électronique que vous lui soumettez volontairement. Ces données collectées vous permettent 
        d'accéder à votre espace personnel et à votre bibliothèque numérique.
        </p>
        Les données collectées ne seront pas communiquées en dehors de l'Editeur.
        ...
        Vous pouvez également retirer à tout moment votre consentement au traitement 
        de vos données, vous opposer au traitement de vos données ou exercer votre droit à la 
